        ...
        public static void RunExample()
        {
            ...
            if (hostMode)
            {
                ...
                NetworkComms.PacketHandlerCallBackDelegate<int> ReplyDelegate = (packetHeader, connection, incomingObject) =>
                {
                    ...
                    DFS.PushItemToPeer(connection.ConnectionInfo.NetworkIdentifier, newItem, "BigDataRequestResponse");
                ...
                Console.WriteLine("\nPress 'q' to close any connected peers or 'ctrl+q' to close this host.\n");
