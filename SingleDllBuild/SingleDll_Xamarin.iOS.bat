...
COPY ..\Platforms\Xamarin.iOS\NetworkCommsDotNet\bin\%1\NetworkCommsDotNet.xml .\%1\NetworkCommsDotNet.xml
...
COPY ..\Platforms\Xamarin.iOS\DPSBase\bin\%1\DPSBase.xml .\%1\DPSBase.xml
...
COPY ..\Platforms\Xamarin.iOS\SevenZipLZMACompressor\bin\%1\SevenZipLZMACompressor.xml .\%1\SevenZipLZMACompressor.xml
...
COPY ..\Platforms\Xamarin.iOS\SharpZipLibCompressor\bin\%1\SharpZipLibCompressor.xml .\%1\SharpZipLibCompressor.xml

md ".\Xamarin.iOS"
REM md ".\Xamarin.iOS\%1\Complete"
md ".\Xamarin.iOS\%1\Core"

REM .\ILMerge.exe /lib:"%ProgramFiles(x86)%\Reference Assemblies\Microsoft\Framework\MonoTouch\v4.0" /out:.\Xamarin.iOS\%1\Core\NetworkCommsDotNetCore.dll .\%1\NetworkCommsDotNet.dll .\%1\protobuf-net.dll .\%1\DPSBase.dll .\%1\SevenZipLZMACompressor.dll /xmldocs
